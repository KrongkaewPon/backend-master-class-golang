...
func (c *simpleBankClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedSimpleBankServer) CreateUser(context.Context, *CreateUserRequest) (*UserResponse, error) {
